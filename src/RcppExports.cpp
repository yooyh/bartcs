...
BEGIN_RCPP
    ...
    fit_separate(Y1, Y0, var_count, var_prob, sigma2_out1_hist, sigma2_out0_hist, dir_alpha_hist, Y_treated, Y_control, trt, X, X_treated, X_control, chain_idx, num_chain, total_iter, num_burn_in, num_thin, num_post_sample, num_tree, step_prob, alpha, beta, nu, lambda_out1, lambda_out0, is_binary_trt, parallel, verbose);
    return R_NilValue;
END_RCPP
}
// fit_single
void fit_single(NumericVector& Y1, NumericVector& Y0, NumericMatrix& var_count, NumericVector& var_prob, double& sigma2_exp, NumericVector& sigma2_out_hist, NumericVector& dir_alpha_hist, const NumericVector& Y, const NumericVector& trt, const NumericMatrix& X, const double trt_treated, const double trt_control, const int chain_idx, const int num_chain, const int total_iter, const int num_burn_in, const int num_thin, const int num_post_sample, const int num_tree, const NumericVector& step_prob, const double alpha, const double beta, const double nu, const double lambda_exp, const double lambda_out, const bool is_binary_trt, const bool parallel, const bool verbose);
RcppExport SEXP _bartcs_fit_single(SEXP Y1SEXP, SEXP Y0SEXP, SEXP var_countSEXP, SEXP var_probSEXP, SEXP sigma2_expSEXP, SEXP sigma2_out_histSEXP, SEXP dir_alpha_histSEXP, SEXP YSEXP, SEXP trtSEXP, SEXP XSEXP, SEXP trt_treatedSEXP, SEXP trt_controlSEXP, SEXP chain_idxSEXP, SEXP num_chainSEXP, SEXP total_iterSEXP, SEXP num_burn_inSEXP, SEXP num_thinSEXP, SEXP num_post_sampleSEXP, SEXP num_treeSEXP, SEXP step_probSEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP nuSEXP, SEXP lambda_expSEXP, SEXP lambda_outSEXP, SEXP is_binary_trtSEXP, SEXP parallelSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector& >::type Y1(Y1SEXP);
    Rcpp::traits::input_parameter< NumericVector& >::type Y0(Y0SEXP);
    ...
    Rcpp::traits::input_parameter< const bool >::type parallel(parallelSEXP);
    Rcpp::traits::input_parameter< const bool >::type verbose(verboseSEXP);
    fit_single(Y1, Y0, var_count, var_prob, sigma2_exp, sigma2_out_hist, dir_alpha_hist, Y, trt, X, trt_treated, trt_control, chain_idx, num_chain, total_iter, num_burn_in, num_thin, num_post_sample, num_tree, step_prob, alpha, beta, nu, lambda_exp, lambda_out, is_binary_trt, parallel, verbose);
    return R_NilValue;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_bartcs_fit_separate", (DL_FUNC) &_bartcs_fit_separate, 29},
    {"_bartcs_fit_single", (DL_FUNC) &_bartcs_fit_single, 28},
    {NULL, NULL, 0}
};
